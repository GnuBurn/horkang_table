...
class CameraWidget(QFrame):
    ...
    def __init__(self, cam_id):
        super().__init__()
        self.cam_id = cam_id
        self.table_count = 0 # Placeholder for future AI data
        self.setStyleSheet("background-color: #1a1a1a; border: 1px solid #333; border-radius: 8px;")
        
        # Main Layout for this camera box
        self.main_layout = QVBoxLayout(self)

        # 1. Top Bar (ID and Delete)
...
class CCTVManager(QMainWindow):
    ...
    def setup_sidebar(self):
        ...
        self.add_btn.setStyleSheet("background: #0078d7; font-weight: bold; border-radius: 5px;")
